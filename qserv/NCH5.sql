...
can't seem to assign aliases to arithmetic combinations 
584 rows in 5s, 1 more row than SQL Server (rounding differences in kMag-kMin)
*/

SELECT s.sourceID,s.ra,s.decl,v.frameSetID,v.jmedianMag,v.jMagRms,v.jnGoodObs,v.jskewness,v.hmedianMag, 
v.hMagRms,v.hnGoodObs,v.hskewness, v.kmedianMag, v.kMagRms,v.knGoodObs,v.kskewness,
