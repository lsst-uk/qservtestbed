/* 10 - Return info about extremely red objects (query 066):
Notes from page: Received that query through Andy Lawrence. Not sure if it will be commonly used in LSST, but for sure it pushing the complexity of SQL.
Link also attempts to tidy up the query a little
